    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome To Rest Api ZaaXxyZzModDev</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6283863668404">WhatsApp</a></span></span>
      ...
      let mailOptions = {
        from: '"ZaaXxyZzModDev" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api ZaaXxyZzModDev`,
        html: inboxGmail,
      };
